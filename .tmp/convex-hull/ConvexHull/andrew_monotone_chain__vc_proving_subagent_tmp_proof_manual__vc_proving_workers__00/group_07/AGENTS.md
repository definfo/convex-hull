...
- Do NOT inspect compile-only dependency paths with shell tools or editor reads. In particular, do not run `cat`, `sed`, `rg`, `grep`, `find`, `ls`, `head`, `tail`, or similar commands on:
  ...
  - `/home/definfo/Develop/qcp/convex-hull/.tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_subagent_tmp_proof_manual__vc_proving_workers__00/group_07/case_deps/convex_hull`
...
## Assigned Goals
- `proof_of_andrew_monotone_chain_entail_wit_6` (`goal_31__proof_of_andrew_monotone_chain_entail_wit_6.v`)
- `proof_of_andrew_monotone_chain_entail_wit_7` (`goal_32__proof_of_andrew_monotone_chain_entail_wit_7.v`)
- `proof_of_andrew_monotone_chain_entail_wit_8_1` (`goal_33__proof_of_andrew_monotone_chain_entail_wit_8_1.v`)
- `proof_of_andrew_monotone_chain_entail_wit_8_2` (`goal_34__proof_of_andrew_monotone_chain_entail_wit_8_2.v`)
- `proof_of_andrew_monotone_chain_entail_wit_9` (`goal_35__proof_of_andrew_monotone_chain_entail_wit_9.v`)
- `proof_of_andrew_monotone_chain_partial_solve_wit_21_pure` (`goal_37__proof_of_andrew_monotone_chain_partial_solve_wit_21_pure.v`)

## Proof Group Notes
- proof_group_id: andrew_upper_scan
- grouping_source: vc-checking-group-plan
- representative_witness: proof_of_andrew_monotone_chain_entail_wit_7
- natural_language_proof_pattern: Expose upper loop bounds and capacity, pop/push upper scan points, and finish the unfolded final postcondition with complete hull shape and convex hull bridge.
- shared_helper_candidates: andrew_upper_scan_inv_pop, andrew_upper_scan_inv_push
- proving_hints: Use point_array_seg_pop_tail/snoc spatial lemmas; final VC uses read <= 1 from loop exit and is_convex_hull_base_permutation.
