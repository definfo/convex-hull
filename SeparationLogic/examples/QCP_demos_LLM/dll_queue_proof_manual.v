...
Proof.
	pre_process.
	sep_apply_l_atomic (dllseg_head_neq qheadnext_2 0 qhead qtail_2 l H).
...
Proof.
	...
	- cancel ((&((q_pre)  # "queue" ->ₛ "head")) # Ptr  |-> qhead).
		...
		sep_apply (dllseg_len1 qhead 0 qheadnext headv Hqhead_neq).
		sep_apply (dllseg_dllseg qhead).
		rewrite H0.
		simpl.
		unfold NULL.
...
Proof.
	pre_process.
	sep_apply (dllseg_head_zero qheadnext 0 qhead qtail l ltac:(lia)).
	Intros.
	subst.
	unfold store_queue.
	Exists 0 0.
