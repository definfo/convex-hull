...
- Do NOT inspect compile-only dependency paths with shell tools or editor reads. In particular, do not run `cat`, `sed`, `rg`, `grep`, `find`, `ls`, `head`, `tail`, or similar commands on:
  ...
  - `/home/definfo/Develop/qcp/convex-hull/.tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_subagent_tmp_proof_manual__vc_proving_workers__00/group_01/case_deps/convex_hull`
...
## Assigned Goals
- `proof_of_cross_prod_safety_wit_1` (`goal_06__proof_of_cross_prod_safety_wit_1.v`)
- `proof_of_cross_prod_safety_wit_2` (`goal_07__proof_of_cross_prod_safety_wit_2.v`)
- `proof_of_cross_prod_safety_wit_3` (`goal_08__proof_of_cross_prod_safety_wit_3.v`)
- `proof_of_cross_prod_safety_wit_4` (`goal_09__proof_of_cross_prod_safety_wit_4.v`)
- `proof_of_cross_prod_safety_wit_5` (`goal_10__proof_of_cross_prod_safety_wit_5.v`)
- `proof_of_cross_prod_safety_wit_6` (`goal_11__proof_of_cross_prod_safety_wit_6.v`)
- `proof_of_cross_prod_safety_wit_7` (`goal_12__proof_of_cross_prod_safety_wit_7.v`)
- `proof_of_cross_prod_return_wit_1` (`goal_13__proof_of_cross_prod_return_wit_1.v`)

## Proof Group Notes
- proof_group_id: cross_prod_arithmetic
- grouping_source: vc-checking-group-plan
- representative_witness: proof_of_cross_prod_safety_wit_1
- natural_language_proof_pattern: Use point coordinate bounds to prove signed-integer safety for differences/products; return VC is definitional equality for point_cross_by_value.
- shared_helper_candidates: empty
- proving_hints: Unfold point_bound/point_in_bound and use nia/lia for bounded arithmetic.
