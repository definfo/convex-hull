...
|--
  ...
  &&  “ (((Znth 0 pts_sorted __default_Point).(x) ) = gx) ” 
  &&  “ (((Znth 0 pts_sorted __default_Point).(y) ) = gy) ”
  &&  ((&((pts_pre)  # "Point" ->ₛ "y")) # Int  |-> (point_y ((point_mk (gx) (gy)))))
  **  ((&((pts_pre)  # "Point" ->ₛ "x")) # Int  |-> (point_x ((point_mk (gx) (gy)))))
