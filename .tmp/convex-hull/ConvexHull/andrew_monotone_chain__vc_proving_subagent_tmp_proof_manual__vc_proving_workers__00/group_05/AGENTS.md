...
- Do NOT inspect compile-only dependency paths with shell tools or editor reads. In particular, do not run `cat`, `sed`, `rg`, `grep`, `find`, `ls`, `head`, `tail`, or similar commands on:
  ...
  - `/home/definfo/Develop/qcp/convex-hull/.tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_subagent_tmp_proof_manual__vc_proving_workers__00/group_05/case_deps/convex_hull`
...
## Assigned Goals
- `proof_of_quicksort_xy_points_return_wit_1` (`goal_21__proof_of_quicksort_xy_points_return_wit_1.v`)
- `proof_of_quicksort_xy_points_return_wit_2` (`goal_22__proof_of_quicksort_xy_points_return_wit_2.v`)
- `proof_of_quicksort_xy_points_return_wit_3` (`goal_23__proof_of_quicksort_xy_points_return_wit_3.v`)
- `proof_of_quicksort_xy_points_return_wit_4` (`goal_24__proof_of_quicksort_xy_points_return_wit_4.v`)

## Proof Group Notes
- proof_group_id: quicksort_xy_composition
- grouping_source: vc-checking-group-plan
- representative_witness: proof_of_quicksort_xy_points_return_wit_1
- natural_language_proof_pattern: Compose partition result with recursive sorted ranges; degenerate boundary cases use range-sorted helper lemmas.
- shared_helper_candidates: point_xy_sorted_range_degenerate, point_xy_sorted_range_from_left_boundary, point_xy_sorted_range_from_right_boundary, point_xy_sorted_range_partition_merge
- proving_hints: Use permutation transitivity, same-outside weaken/transitivity, partitioned-at facts, and sorted range composition.
