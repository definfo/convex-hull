...
include convexhull-coq.mk.conf
...
# put in convexhull-coq.mk.local double colon rules accordingly.
# E.g. to perform some work after the all target completes you can write
#
# post-all::
# 	echo "All done!"
#
# in convexhull-coq.mk.local
#
###############################################################################
...
#
# There rules can be extended in convexhull-coq.mk.local
...
# extension points and convexhull-coq.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in convexhull-coq.mk.local or include convexhull-coq.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in convexhull-coq.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create convexhull-coq.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include convexhull-coq.mk.local-late
