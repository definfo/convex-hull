...
- trigger_rule: relaunch after r1 vc-proving-subagent runtime failure, not after VC/annotation failure
- target_scope: all 37 witnesses from current proof manual
- iteration_owner: subagent
- return_condition: completed | blocked | stale
- allowed_read_set: current case C, goal, proof_auto, proof_manual, goal_check, common_case_formal_lib, vc-checking report and group plan, vc-proving scripts/docs, related ConvexHull libraries and LLM reference proofs, r1 status reports for failure context only
...
- scratch_owned_paths: .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_r2_tmp_proof_manual.v; .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_r2_tmp_lib.v; .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_workers/20260630T142504
...
- worker_manual_workdir: .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_workers/20260630T142504
- worker_reports: .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2/worker_reports
...
- round_report_dir: .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2
- timing_log_path: .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2/timing_log.md
- expected_report_paths: .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2/proof_strategy_report.md; .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2/subagent_return_report.md; .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2/worker_reports/
...
- allowed_write_set: .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_r2_tmp_proof_manual.v; .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_r2_tmp_lib.v; .tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_workers/20260630T142504; .agents/reports/convex-hull/2026-06-30/andrew_monotone_chain-20260630T013537/20260630T142504-vc-proving-r2
- forbidden_write_set: official main-state files; stale r1 scratch/workdir; generated files; common_case_formal_lib; proof manual; unrelated source files
...
- cleanup_paths: fresh r2 scratch/workdir after completion/stale/main integration; stale r1 scratch cleanup remains pending because main cleanup was rejected by approval layer
...
- why_reentered: r1 vc-proving-subagent errored at agent runtime with `exceeded retry limit, last status: 429 Too Many Requests`; it did not return completed/blocked/stale.
- what_failed_last_round: subagent transport/backend, not Rocq proof, not annotation, not VC semantics.
- affected_witnesses_or_files: all 37 witness goals remain unproved in official proof_manual; stale partial r1 scratch exists under `.tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_subagent_tmp_*` and must not be reused as proof result.
- what_changed_since_last_round: no official C/lib/generated/manual inputs changed; r2 uses distinct scratch paths ending in `vc_proving_r2`.
- must_focus_this_round: recreate fresh scratch pair from official files, rerun proof pipeline from scratch, and report completed/blocked/stale.
