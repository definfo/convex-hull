...
forall (j_pre: Z) (i_pre: Z) (arr_pre: Z) (l: (@list Z)) (n: Z) ,
  “ (0 <= i_pre) ” 
  &&  “ (i_pre < n) ” 
  &&  “ (0 <= j_pre) ” 
  &&  “ (j_pre < n) ”
...
forall (high_pre: Z) (low_pre: Z) (n_pre: Z) (arr_pre: Z) (l: (@list Z)) (l1_2: (@list Z)) (j: Z) (i: Z) (pivot: Z) ,
  ...
  &&  “ (i < j) ” 
  &&  “ (j <= high_pre) ” 
  &&  “ (partition_scan_inv l l1_2 low_pre high_pre pivot i j ) ”
...
forall (right_pre: Z) (left_pre: Z) (n_pre: Z) (arr_pre: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) (l1_4: (@list Z)) ,
  ...
  &&  “ (sorted_range l1_4 (retval + 1 ) right_pre ) ” 
  &&  “ (retval < right_pre) ” 
  &&  “ (permutation l1_2 l1_3 ) ” 
  &&  “ (same_outside_range l1_2 l1_3 left_pre (retval - 1 ) ) ” 
  &&  “ (sorted_range l1_3 left_pre (retval - 1 ) ) ” 
  &&  “ (retval > left_pre) ” 
  &&  “ (left_pre <= retval) ” 
  &&  “ (retval <= right_pre) ” 
  &&  “ (permutation l l1_2 ) ” 
...
forall (right_pre: Z) (left_pre: Z) (n_pre: Z) (arr_pre: Z) (l: (@list Z)) (l1_2: (@list Z)) (retval: Z) (l1_3: (@list Z)) ,
  ...
  &&  “ (sorted_range l1_3 (retval + 1 ) right_pre ) ” 
  &&  “ (retval < right_pre) ” 
  &&  “ (retval <= left_pre) ” 
  &&  “ (left_pre <= retval) ” 
  &&  “ (retval <= right_pre) ” 
