...
- Do NOT inspect compile-only dependency paths with shell tools or editor reads. In particular, do not run `cat`, `sed`, `rg`, `grep`, `find`, `ls`, `head`, `tail`, or similar commands on:
  ...
  - `/home/definfo/Develop/qcp/convex-hull/.tmp/convex-hull/ConvexHull/andrew_monotone_chain__vc_proving_subagent_tmp_proof_manual__vc_proving_workers__00/group_03/case_deps/convex_hull`
...
## Assigned Goals
- `proof_of_partition_xy_points_entail_wit_1` (`goal_15__proof_of_partition_xy_points_entail_wit_1.v`)
- `proof_of_partition_xy_points_entail_wit_2_1` (`goal_16__proof_of_partition_xy_points_entail_wit_2_1.v`)
- `proof_of_partition_xy_points_entail_wit_2_2` (`goal_17__proof_of_partition_xy_points_entail_wit_2_2.v`)
- `proof_of_partition_xy_points_entail_wit_2_3` (`goal_18__proof_of_partition_xy_points_entail_wit_2_3.v`)

## Proof Group Notes
- proof_group_id: partition_scan
- grouping_source: vc-checking-group-plan
- representative_witness: proof_of_partition_xy_points_entail_wit_2_1
- natural_language_proof_pattern: Establish and preserve point_xy_partition_scan_inv across initialization, accept-with-swap, accept-without-swap, and reject branches.
- shared_helper_candidates: point_xy_partition_scan_inv_accept_swap, point_xy_partition_scan_inv_accept_noswap, point_xy_partition_scan_inv_reject_step
- proving_hints: Unfold point_xy_partition_scan_inv; combine swap lookup/permutation/outside-range facts with branch retval sign facts.
