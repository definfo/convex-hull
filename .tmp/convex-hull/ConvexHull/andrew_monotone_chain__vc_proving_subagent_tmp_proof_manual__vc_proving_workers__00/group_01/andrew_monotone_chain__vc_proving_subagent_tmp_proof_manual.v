...
Proof.
  unfold cross_prod_safety_wit_1; try left.
  intros.
  entailer!.
...
Proof.
  unfold cross_prod_safety_wit_2; try left.
  intros.
  entailer!.
  all: unfold point_bound, Point_Order.point_bound in *; simpl in *.
  all: assert (-20000 <= b_y_pre - a_y_pre <= 20000); [lia |].
...
Proof.
  unfold cross_prod_safety_wit_3; try left.
  intros.
  entailer!.
...
Proof.
  unfold cross_prod_safety_wit_4; try left.
  intros.
  entailer!.
  all: unfold point_bound, Point_Order.point_bound in *; simpl in *; lia.
Qed.
...
Proof.
  unfold cross_prod_safety_wit_5; try left.
  intros.
  entailer!.
  all: unfold point_bound, Point_Order.point_bound in *; simpl in *.
  all: assert (-20000 <= b_x_pre - a_x_pre <= 20000); [lia |].
...
Proof.
  unfold cross_prod_safety_wit_6; try left.
  intros.
  entailer!.
  all: unfold point_bound, Point_Order.point_bound in *; simpl in *; lia.
Qed.
...
Proof.
  unfold cross_prod_safety_wit_7; try left.
  intros.
  entailer!.
  all: unfold point_bound, Point_Order.point_bound in *; simpl in *; lia.
Qed.
...
Proof.
  unfold cross_prod_return_wit_1; try left.
  intros.
  entailer!.
Qed.
