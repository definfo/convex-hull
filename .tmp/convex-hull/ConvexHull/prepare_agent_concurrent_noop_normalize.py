#!/usr/bin/env python3
"""Temporary vc-proving wrapper for a missing local script helper.

The checked-in prepare path references manual_goal_utils.normalize_overlay_strategy_imports
but this repository snapshot does not define it.  This wrapper supplies a no-op
implementation and delegates to prepare_agent_concurrent.main without modifying
the official script.
"""
