...
(
forall (hull_pre: Z) (tail_n_pre: Z) (X_low_level_spec: (unit -> ((@list Point) -> Prop))) (l_low_level_spec: (@list Point)) (pivot0_low_level_spec: Point) (stk_2: (@list Point)) (top: Z) (i: Z)  __default_Point (PreH1 : ((point_y ((Znth i l_low_level_spec __default_Point))) <= INT_MAX)) (PreH2 : ((point_x ((Znth i l_low_level_spec __default_Point))) <= INT_MAX)) (PreH3 : ((point_y ((Znth i l_low_level_spec __default_Point))) >= INT_MIN)) (PreH4 : ((point_x ((Znth i l_low_level_spec __default_Point))) >= INT_MIN)) (PreH5 : (top < 1)) (PreH6 : (0 <= i)) (PreH7 : (i < tail_n_pre)) (PreH8 : (top <= i)) (PreH9 : (0 <= tail_n_pre)) (PreH10 : (tail_n_pre < INT_MAX)) (PreH11 : (tail_n_pre = (Zlength (l_low_level_spec)))) (PreH12 : ((top + 1 ) = (Zlength ((rev (stk_2)))))) (PreH13 : (point_polar_sorted pivot0_low_level_spec l_low_level_spec )) (PreH14 : (point_in_bound pivot0_low_level_spec )) (PreH15 : (points_in_bound l_low_level_spec )) (PreH16 : (points_in_bound (rev (stk_2)) )) (PreH17 : (safeExec (equiv (stk_2)) (build_hull_c_step (l_low_level_spec) (i)) X_low_level_spec )) ,
  ((&(((hull_pre + ((top + 1 ) * sizeof( "Point" ) ) ))  # "Point" ->ₛ "x")) # Int  |-> (point_x ((Znth i l_low_level_spec __default_Point))))
  **  (PointArray.undef_seg hull_pre ((top + 1 ) + 1 ) (tail_n_pre + 1 ) )
  **  ((&(((hull_pre + ((top + 1 ) * sizeof( "Point" ) ) ))  # "Point" ->ₛ "y")) # Int  |-> (point_y ((Znth i l_low_level_spec __default_Point))))
  **  (PointArray.seg hull_pre 0 (top + 1 ) (rev (stk_2)) )
...
(
forall (hull_pre: Z) (tail_n_pre: Z) (X_low_level_spec: (unit -> ((@list Point) -> Prop))) (l_low_level_spec: (@list Point)) (pivot0_low_level_spec: Point) (stk_2: (@list Point)) (top: Z) (i: Z) (retval: Z)  __default_Point (PreH1 : ((point_y ((Znth i l_low_level_spec __default_Point))) <= INT_MAX)) (PreH2 : ((point_x ((Znth i l_low_level_spec __default_Point))) <= INT_MAX)) (PreH3 : ((point_y ((Znth i l_low_level_spec __default_Point))) >= INT_MIN)) (PreH4 : ((point_x ((Znth i l_low_level_spec __default_Point))) >= INT_MIN)) (PreH5 : (retval > 0)) (PreH6 : (retval = (point_cross_by_value ((point_x ((Znth ((top - 1 ) - 0 ) (rev (stk_2)) __default_Point)))) ((point_y ((Znth ((top - 1 ) - 0 ) (rev (stk_2)) __default_Point)))) ((point_x ((Znth (top - 0 ) (rev (stk_2)) __default_Point)))) ((point_y ((Znth (top - 0 ) (rev (stk_2)) __default_Point)))) ((point_x ((Znth i l_low_level_spec __default_Point)))) ((point_y ((Znth i l_low_level_spec __default_Point))))))) (PreH7 : (top >= 1)) (PreH8 : (0 <= i)) (PreH9 : (i < tail_n_pre)) (PreH10 : (top <= i)) (PreH11 : (0 <= tail_n_pre)) (PreH12 : (tail_n_pre < INT_MAX)) (PreH13 : (tail_n_pre = (Zlength (l_low_level_spec)))) (PreH14 : ((top + 1 ) = (Zlength ((rev (stk_2)))))) (PreH15 : (point_polar_sorted pivot0_low_level_spec l_low_level_spec )) (PreH16 : (point_in_bound pivot0_low_level_spec )) (PreH17 : (points_in_bound l_low_level_spec )) (PreH18 : (points_in_bound (rev (stk_2)) )) (PreH19 : (safeExec (equiv (stk_2)) (build_hull_c_step (l_low_level_spec) (i)) X_low_level_spec )) ,
  ((&(((hull_pre + ((top + 1 ) * sizeof( "Point" ) ) ))  # "Point" ->ₛ "x")) # Int  |-> (point_x ((Znth i l_low_level_spec __default_Point))))
  **  (PointArray.undef_seg hull_pre ((top + 1 ) + 1 ) (tail_n_pre + 1 ) )
  **  ((&(((hull_pre + ((top + 1 ) * sizeof( "Point" ) ) ))  # "Point" ->ₛ "y")) # Int  |-> (point_y ((Znth i l_low_level_spec __default_Point))))
  **  (PointArray.seg hull_pre 0 (top + 1 ) (rev (stk_2)) )
...
(
forall (hull_pre: Z) (n_pre: Z) (pts_l: (@list Point)) (PreH1 : (2 <= n_pre)) (PreH2 : (n_pre <= 50000)) (PreH3 : ((Zlength (pts_l)) = n_pre)) (PreH4 : (points_in_bound pts_l )) ,
  (PointArray.undef_full hull_pre n_pre )
|--
  “ (point_leftmost_prefix pts_l 0 1 ) ”
  &&  (PointArray.undef_full hull_pre n_pre )
...
Definition graham_scan_entail_wit_1_split_goal_spatial := 
forall (hull_pre: Z) (n_pre: Z) (pts_l: (@list Point)) (PreH1 : (2 <= n_pre)) (PreH2 : (n_pre <= 50000)) (PreH3 : ((Zlength (pts_l)) = n_pre)) (PreH4 : (points_in_bound pts_l )) ,
  (PointArray.undef_full hull_pre n_pre )
|--
  (PointArray.undef_full hull_pre n_pre )
...
Definition graham_scan_entail_wit_2_1_split_goal_spatial := 
forall (hull_pre: Z) (n_pre: Z) (pts_l: (@list Point)) (pivot_idx: Z) (i: Z) (retval: Z)  __default_Point (PreH1 : (retval < 0)) (PreH2 : (retval = (point_cmp_leftdown ((point_mk ((point_x ((Znth i pts_l __default_Point)))) ((point_y ((Znth i pts_l __default_Point)))))) ((point_mk ((point_x ((Znth pivot_idx pts_l __default_Point)))) ((point_y ((Znth pivot_idx pts_l __default_Point))))))))) (PreH3 : (i < n_pre)) (PreH4 : (2 <= n_pre)) (PreH5 : (0 <= n_pre)) (PreH6 : (n_pre <= 50000)) (PreH7 : (1 <= i)) (PreH8 : (i <= n_pre)) (PreH9 : (0 <= pivot_idx)) (PreH10 : (pivot_idx < i)) (PreH11 : (point_leftmost_prefix pts_l pivot_idx i )) (PreH12 : ((Zlength (pts_l)) = n_pre)) (PreH13 : (points_in_bound pts_l )) ,
  (PointArray.undef_full hull_pre n_pre )
|--
  (PointArray.undef_full hull_pre n_pre )
...
Definition graham_scan_entail_wit_2_2_split_goal_spatial := 
forall (hull_pre: Z) (n_pre: Z) (pts_l: (@list Point)) (pivot_idx: Z) (i: Z) (retval: Z)  __default_Point (PreH1 : (retval >= 0)) (PreH2 : (retval = (point_cmp_leftdown ((point_mk ((point_x ((Znth i pts_l __default_Point)))) ((point_y ((Znth i pts_l __default_Point)))))) ((point_mk ((point_x ((Znth pivot_idx pts_l __default_Point)))) ((point_y ((Znth pivot_idx pts_l __default_Point))))))))) (PreH3 : (i < n_pre)) (PreH4 : (2 <= n_pre)) (PreH5 : (0 <= n_pre)) (PreH6 : (n_pre <= 50000)) (PreH7 : (1 <= i)) (PreH8 : (i <= n_pre)) (PreH9 : (0 <= pivot_idx)) (PreH10 : (pivot_idx < i)) (PreH11 : (point_leftmost_prefix pts_l pivot_idx i )) (PreH12 : ((Zlength (pts_l)) = n_pre)) (PreH13 : (points_in_bound pts_l )) ,
  (PointArray.undef_full hull_pre n_pre )
|--
  (PointArray.undef_full hull_pre n_pre )
...
|--
  ...
  &&  “ (((Znth 0 pts_sorted __default_Point).(x) ) = (point_x ((Znth 0 pts_l __default_Point)))) ” 
  &&  “ (((Znth 0 pts_sorted __default_Point).(y) ) = (point_y ((Znth 0 pts_l __default_Point)))) ”
  &&  ((&((pts_pre)  # "Point" ->ₛ "y")) # Int  |-> (point_y ((point_mk ((point_x ((Znth 0 pts_l __default_Point)))) ((point_y ((Znth 0 pts_l __default_Point))))))))
  **  ((&((pts_pre)  # "Point" ->ₛ "x")) # Int  |-> (point_x ((point_mk ((point_x ((Znth 0 pts_l __default_Point)))) ((point_y ((Znth 0 pts_l __default_Point))))))))
...
|--
  ...
  &&  “ (((Znth 0 pts_sorted __default_Point).(x) ) = (point_x ((Znth 0 (point_swap (pts_l) (0) (pivot_idx)) __default_Point)))) ” 
  &&  “ (((Znth 0 pts_sorted __default_Point).(y) ) = (point_y ((Znth 0 (point_swap (pts_l) (0) (pivot_idx)) __default_Point)))) ”
  &&  ((&((pts_pre)  # "Point" ->ₛ "y")) # Int  |-> (point_y ((point_mk ((point_x ((Znth 0 (point_swap (pts_l) (0) (pivot_idx)) __default_Point)))) ((point_y ((Znth 0 (point_swap (pts_l) (0) (pivot_idx)) __default_Point))))))))
  **  ((&((pts_pre)  # "Point" ->ₛ "x")) # Int  |-> (point_x ((point_mk ((point_x ((Znth 0 (point_swap (pts_l) (0) (pivot_idx)) __default_Point)))) ((point_y ((Znth 0 (point_swap (pts_l) (0) (pivot_idx)) __default_Point))))))))
  **  (PointArray.full (pts_pre + (1 * sizeof( "Point" ) ) ) (n_pre - 1 ) (sublist (1) (n_pre) (pts_sorted)) )
  **  (PointArray.undef_full hull_pre ((n_pre - 1 ) + 1 ) )
).
...
(
forall (hull_pre: Z) (n_pre: Z) (pts_pre: Z) (pts_l: (@list Point)) (pts_pivot: (@list Point)) (pts_sorted: (@list Point)) (tail_sorted: (@list Point)) (pivot0: Point) (tail: Z) (gy: Z) (gx: Z) (pivot_idx: Z)  __default_Point (PreH1 : (pivot_idx <= INT_MAX)) (PreH2 : (gx <= INT_MAX)) (PreH3 : (gy <= INT_MAX)) (PreH4 : (n_pre <= INT_MAX)) (PreH5 : ((point_x (pivot0)) <= INT_MAX)) (PreH6 : ((point_y (pivot0)) <= INT_MAX)) (PreH7 : (pivot_idx >= INT_MIN)) (PreH8 : (gx >= INT_MIN)) (PreH9 : (gy >= INT_MIN)) (PreH10 : (n_pre >= INT_MIN)) (PreH11 : ((point_x (pivot0)) >= INT_MIN)) (PreH12 : ((point_y (pivot0)) >= INT_MIN)) (PreH13 : (tail = (pts_pre + sizeof( "Point" ) ))) (PreH14 : (2 <= n_pre)) (PreH15 : (n_pre <= 50000)) (PreH16 : (pivot0 = (point_mk (gx) (gy)))) (PreH17 : (pts_pivot = (point_swap (pts_l) (0) (pivot_idx)))) (PreH18 : ((Zlength (pts_sorted)) = n_pre)) (PreH19 : ((Zlength (tail_sorted)) = (n_pre - 1 ))) (PreH20 : (tail_sorted = (sublist (1) (n_pre) (pts_sorted)))) (PreH21 : (points_in_bound pts_sorted )) (PreH22 : (points_in_bound tail_sorted )) (PreH23 : (point_in_bound pivot0 )) (PreH24 : (point_leftmost_prefix pts_l pivot_idx n_pre )) (PreH25 : (leftmost pivot0 pts_sorted )) (PreH26 : (point_permutation pts_pivot pts_sorted )) (PreH27 : (point_sorted_range (point_mk (gx) (gy)) pts_sorted 1 (n_pre - 1 ) )) (PreH28 : (point_polar_sorted pivot0 tail_sorted )) (PreH29 : (leftmost pivot0 (rev (tail_sorted)) )) (PreH30 : (((Znth 0 pts_sorted __default_Point).(x) ) = gx)) (PreH31 : (((Znth 0 pts_sorted __default_Point).(y) ) = gy)) ,
  ((&((pts_pre)  # "Point" ->ₛ "y")) # Int  |-> (point_y (pivot0)))
  **  ((&((pts_pre)  # "Point" ->ₛ "x")) # Int  |-> (point_x (pivot0)))
  **  ((( &( "ret" ) )) # Int  |->_)
  **  ((( &( "pts" ) )) # Ptr  |-> pts_pre)
...
Definition graham_scan_partial_solve_wit_13_pure_split_goal_1 := 
forall (hull_pre: Z) (n_pre: Z) (pts_pre: Z) (pts_l: (@list Point)) (pts_pivot: (@list Point)) (pts_sorted: (@list Point)) (tail_sorted: (@list Point)) (pivot0: Point) (tail: Z) (gy: Z) (gx: Z) (pivot_idx: Z)  __default_Point (PreH1 : (pivot_idx <= INT_MAX)) (PreH2 : (gx <= INT_MAX)) (PreH3 : (gy <= INT_MAX)) (PreH4 : (n_pre <= INT_MAX)) (PreH5 : ((point_x (pivot0)) <= INT_MAX)) (PreH6 : ((point_y (pivot0)) <= INT_MAX)) (PreH7 : (pivot_idx >= INT_MIN)) (PreH8 : (gx >= INT_MIN)) (PreH9 : (gy >= INT_MIN)) (PreH10 : (n_pre >= INT_MIN)) (PreH11 : ((point_x (pivot0)) >= INT_MIN)) (PreH12 : ((point_y (pivot0)) >= INT_MIN)) (PreH13 : (tail = (pts_pre + sizeof( "Point" ) ))) (PreH14 : (2 <= n_pre)) (PreH15 : (n_pre <= 50000)) (PreH16 : (pivot0 = (point_mk (gx) (gy)))) (PreH17 : (pts_pivot = (point_swap (pts_l) (0) (pivot_idx)))) (PreH18 : ((Zlength (pts_sorted)) = n_pre)) (PreH19 : ((Zlength (tail_sorted)) = (n_pre - 1 ))) (PreH20 : (tail_sorted = (sublist (1) (n_pre) (pts_sorted)))) (PreH21 : (points_in_bound pts_sorted )) (PreH22 : (points_in_bound tail_sorted )) (PreH23 : (point_in_bound pivot0 )) (PreH24 : (point_leftmost_prefix pts_l pivot_idx n_pre )) (PreH25 : (leftmost pivot0 pts_sorted )) (PreH26 : (point_permutation pts_pivot pts_sorted )) (PreH27 : (point_sorted_range (point_mk (gx) (gy)) pts_sorted 1 (n_pre - 1 ) )) (PreH28 : (point_polar_sorted pivot0 tail_sorted )) (PreH29 : (leftmost pivot0 (rev (tail_sorted)) )) (PreH30 : (((Znth 0 pts_sorted __default_Point).(x) ) = gx)) (PreH31 : (((Znth 0 pts_sorted __default_Point).(y) ) = gy)) ,
  ((&((pts_pre)  # "Point" ->ₛ "y")) # Int  |-> (point_y (pivot0)))
  **  ((&((pts_pre)  # "Point" ->ₛ "x")) # Int  |-> (point_x (pivot0)))
  **  ((( &( "ret" ) )) # Int  |->_)
