...
forall (q_pre: Z) (l: (@list Z)) (x: Z) (qhead: Z) (qtail: Z) (qheadnext: Z) ,
  “ (qhead <> 0) ”
  &&  ((( &( "x0" ) )) # Int  |-> x)
  **  ((( &( "p" ) )) # Ptr  |-> qhead)
  **  ((( &( "q" ) )) # Ptr  |-> q_pre)
...
forall (q_pre: Z) (l: (@list Z)) (x: Z) (qhead: Z) (qtail: Z) (headv: Z) (qheadnext: Z) (l0: (@list Z)) (p: Z) ,
  “ (qhead <> 0) ” 
  &&  “ (l = (cons (headv) (l0))) ”
  &&  ((( &( "q" ) )) # Ptr  |-> q_pre)
  **  ((( &( "x0" ) )) # Int  |-> x)
...
forall (q_pre: Z) (l: (@list Z)) (qhead: Z) (qtail_2: Z) (qheadnext_2: Z) ,
  “ (qheadnext_2 <> 0) ” 
  &&  “ (qhead <> 0) ”
...
forall (q_pre: Z) (l: (@list Z)) (x: Z) (qhead: Z) (qtail: Z) (headv: Z) (qheadnext: Z) (l0: (@list Z)) ,
  “ (qhead <> 0) ” 
  &&  “ (l = (cons (headv) (l0))) ”
  &&  ((&((qhead)  # "list" ->ₛ "prev")) # Ptr  |-> 0)
  **  ((&((qhead)  # "list" ->ₛ "data")) # Int  |-> headv)
